...
=======
    ...
    const [graphU, setGraphU] = useState([]);
    const [graphTh, setGraphTh] = useState([]);
    const [uLineData, setULineData] = useState(null);
    const [thLineData, setThLineData] = useState(null);
...
=======
                const [graphU, uLinedata] = activityProcessor.getUraniumSeriesGraph();
                const [graphTh, thLinedata] = activityProcessor.getThoriumSeriesGraph();
>>>>>>> 7b7881f (Changes suggested by mail on 12/27/24)
...
<<<<<<< HEAD
                setGraphTh(graphTh);
=======
                setULineData(uLinedata);
                setGraphTh(graphTh);
                setThLineData(thLinedata);
>>>>>>> 7b7881f (Changes suggested by mail on 12/27/24)
            }).catch((error) => {
...
<<<<<<< HEAD
            ...
            <button 
=======
                <div class="w-5/6 h-full flex flex-row justify-center items-center ">
                        <div class="text-3xl mb-8">
                            Uranium Decay Series
                            {graphU && uLineData && (<SeriesGraph scatterData={graphU} lineData={uLineData}/>)}
                ...
                <div class="w-5/6 h-full flex flex-row justify-center items-center ">
                        <div class="text-3xl mb-8">
                            Thorium Decay Series
                            {graphTh && thLineData && (<SeriesGraph scatterData={graphTh} lineData={thLineData}/>)}
            ...
            <Dashboard handlerNext={handleNext} showNext={true}/>
