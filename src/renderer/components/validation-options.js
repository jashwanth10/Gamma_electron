...
const ValidationOptions = ({handlerRevertCoefficients, handlerIteration, handlerRetainCoefficients}) => {
    ...
    <div className="w-full flex justify-center p-4 bg-base-200">
        <div className="dropdown">
            ...
            {isOpen && (
                <ul tabIndex={0} className="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
                    ...
                    <li key={1}><a onClick={() => {
                        handlerIteration("One more iteration");
        ...
        {/* <div className="space-x-4 flex flex-row">
            ...
            <button className="btn btn-outline btn-accent z-10" onClick={() => handlerIteration()}>One more iteration</button>
