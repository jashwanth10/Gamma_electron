...
function Metadata() {
  ...
  const flashcards = [
    { title: "Background spectra", csvPath: "meta/background.csv" },
    { title: "Efficieny", csvPath: "meta/efficiency.csv" },
    { title: "Count Rate", csvPath: "meta/count_rate.csv" },
    { title: "Efficiency (secondary)", csvPath: "meta/efficiency_v2.csv" },
  ];
  ...
  const handleNext = () => {
    navigate('/analysis', {state: {activityPeaksForGraph}});
  }
